 ...
 * Public-API snapshot.
 *
 * Snapshots the built public type declarations of every entry point (the root and
 * each subpath) from dist/<entry>.d.mts to api/<entry>.d.mts, so
...
const ENTRIES = ["index", "gif-entry", "webp-entry", "svg-logo-entry", "prores-entry", "cli/index"];
