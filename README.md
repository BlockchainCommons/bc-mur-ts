...
import {
  ...
  MurError,
  Error,
} from "@blockchaincommons/multipart-ur";
```

Runnable examples live in the [`examples/`](https://github.com/BlockchainCommons/bc-mur-ts/tree/master/examples) directory.
...
`@blockchaincommons/multipart-ur` depends on `@blockchaincommons/uniform-resources`, `@resvg/resvg-wasm`, `fast-png`, `gifenc`, `jpeg-js`, `omggif`, `qrcode-generator`, `webp-wasm` at runtime.
